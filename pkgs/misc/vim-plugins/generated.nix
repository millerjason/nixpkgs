  ...
  packages = ( self:
{
  ...
  deoplete-nvim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "Shougo";
      repo = "deoplete.nvim";
      rev = "4e94c6921977afdf9a1ecdbe637f86df10eae775";
      sha256 = "1pm20mlrf1di6h73c74gcibvsks27xgxgv7n96v06cr5kx31ha1h";
    };
  };
  ...
  falcon = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "fenetikm";
      repo = "falcon";
      rev = "98b79399aedeac1c20aad6e45b456a942ef162ac";
      sha256 = "08snr9z70bnyxm6z8h1fxm1wfv54dsnjk6476n70aicpvpdbmnz0";
    };
  };
  ...
  ghcid = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "ndmitchell";
      repo = "ghcid";
      rev = "55d6633c2c8f628ffad7e8596e60ffa0e0f83092";
      sha256 = "0mvwzpf4qnq7y1ff24znski0rc5p4hh4bf19bd8fc982wrlbbj6m";
    };
  };
  ...
  lightline-vim = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "itchyny";
      repo = "lightline.vim";
      rev = "d437b6fe92e73c80978c2c4942aa51bc7d835a2e";
      sha256 = "05d09vkz5d680plff3m3mw9a13wxi22hp3qzb8y0hkdmr058vdrw";
    };
  };
  ...
  vim-fugitive = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "tpope";
      repo = "vim-fugitive";
      rev = "f5fc469c0c511a5196b6c2ba565b2b6bf6a9d1aa";
      sha256 = "1qrw1b4g38qdcwagn7pgish1spd5nwy9xv047rcldlr3wdb8zj22";
    };
  };
  ...
  vim-go = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "fatih";
      repo = "vim-go";
      rev = "dc371c5431585af3fda47e06ba062b2225206fc9";
      sha256 = "1v19q8ls896p1dv4zc02f8d18jmskskikgsnj1b4cvqfmfr2rf45";
    };
  };
  ...
  vimtex = buildVimPluginFrom2Nix {
    ...
    src = fetchFromGitHub {
      owner = "lervag";
      repo = "vimtex";
      rev = "57648ccbc1e20e751a75a56d87648b383922df2d";
      sha256 = "16dqnbb85zisjxm4idy7yj2dnf2z9yk5y0pyl8l3hjqg8rvyzx69";
    };
  };
